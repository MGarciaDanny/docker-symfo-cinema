 ...
 */
final class Version20230604212420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie_has_people (movie_id INT NOT NULL, people_id INT NOT NULL, signifiance enum(\'PRINCIPAL\',\'SECONDAIRE\'), INDEX IDX_EDC40D818F93B6FC (movie_id), INDEX IDX_EDC40D813147C936 (people_id), PRIMARY KEY(movie_id, people_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
